...
import com.crystal.sharelocation.databinding.ActivityMapBinding
...
class MapActivity : AppCompatActivity(), OnMapReadyCallback, OnMarkerClickListener {
    ...
    private fun setupEmojiAnimationView() {
        binding.emojiLottieAnimationView.setOnClickListener {
            ...
            if (trackingPersonId != "") {
                ...
                Log.d("MapActivity", "tag: $trackingPersonId")
    ...
    override fun onMarkerClick(marker: Marker): Boolean {
        ...
        Log.d("MapActivity", "marker tag: ${marker.tag}")

        val bottomSheetBehavior = BottomSheetBehavior.from(binding.emojiBottomSheetDialogLayout)
