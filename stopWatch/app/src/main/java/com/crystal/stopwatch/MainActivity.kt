...
import com.crystal.stopwatch.databinding.ActivityMainBinding
import com.crystal.stopwatch.databinding.DialogCountdownSettingBinding
    ...
    private fun start() {
        timer = timer(initialDelay = 0, period = 100) {
            ...
            if (currentDeciSecond == 0 && currentCountdownDeciSecond < 31 && currentCountdownDeciSecond % 10 == 0) {
                val toneType = if (currentCountdownDeciSecond == 0) ToneGenerator.TONE_CDMA_HIGH_L else ToneGenerator.TONE_CDMA_ONE_MIN_BEEP
